 ...
 - **Codex 桌面版與 Claude Desktop 整合**：新增專屬 Skill（`skills/claude-handoff`），讓使用者在 Codex 桌面版聊天室以自然語言直接接手 Claude 5 小時額度上限的 Session，無需手動執行任何命令列。
 ...
 | `skills/claude-handoff/SKILL.md` | Codex 桌面版免指令接手 Skill |
